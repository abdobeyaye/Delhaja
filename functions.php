...
$text = [
    'ar' => [
        ...
        'select_pickup_district' => 'اختر مقاطعة الاستلام',
        'select_delivery_district' => 'اختر مقاطعة التوصيل',
        'select_from_district' => 'من أين يجب أن نستلم؟',
        'select_to_district' => 'إلى أين يجب أن نوصل؟',
        'delivery_fee' => 'رسوم التوصيل',
        'from' => 'من',
        'to' => 'إلى',
        'detailed_address' => 'العنوان التفصيلي',
        'detailed_address_placeholder' => 'الشارع، المبنى، معلم قريب، تعليمات التوصيل...',
        'district_required' => 'يرجى اختيار مقاطعتي الاستلام والتوصيل',
        ...
        'cancel_order' => 'إلغاء الطلب',
        'cannot_cancel' => 'لا يمكن إلغاء الطلب - تم قبوله من السائق',
    ...
    'fr' => [
        ...
        'select_pickup_district' => 'Sélectionner commune de ramassage',
        'select_delivery_district' => 'Sélectionner commune de livraison',
        'select_from_district' => 'D\'où devons-nous récupérer?',
        'select_to_district' => 'Où devons-nous livrer?',
        'delivery_fee' => 'Frais de livraison',
        'from' => 'De',
        'to' => 'À',
        'detailed_address' => 'Adresse détaillée',
        'detailed_address_placeholder' => 'Rue, immeuble, repère, instructions de livraison...',
        'district_required' => 'Veuillez sélectionner les communes de ramassage et de livraison',
        ...
        'cannot_cancel' => 'Impossible d\'annuler - commande déjà acceptée',
